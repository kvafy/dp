...
\begin{table}[htb]
    \centering
    \catcode`\-=12
    \begin{adjustwidth}{-0.5cm}{-0.95cm} % table wider than the text column would not be centered
    {\small
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        ...
        \caption{\uv{ICU alarm} network (37 variables, 509 parameters)}
    \end{subfigure}
...
If a concrete application demands estimated network parameters to be as close to the \uv{real ones} as possible, similar analysis, as I just performed, is a~sensible thing to do\,--\,pick a network of similar complexity, plot the learning curves for this network and determine what is the best parameter estimation method with respect to the size of our dataset.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \hspace{-1.5cm}
        \includegraphics[scale=0.36]{fig/structure-learning-child-500-bic}
        \caption{Using the BIC score.}
        \label{fig:structure-learning-child-500-bic}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\linewidth}
        \hspace{-0.6cm}
        \includegraphics[scale=0.36]{fig/structure-learning-child-500-bayes-2_5}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \hspace{-2.4cm}
        \includegraphics[scale=0.36]{fig/structure-learning-child-2000-bic}
        \caption{Using the BIC score.}
        \label{fig:structure-learning-child-2000-bic}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\linewidth}
        \hspace{-0.7cm}
        \includegraphics[scale=0.36]{fig/structure-learning-child-2000-bayes-2_5}
        \caption{Using the Bayesian score with $\alpha = 2.5$.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \hspace{-2.0cm}
        \includegraphics[scale=0.36]{fig/structure-learning-child-5000-bic}
        \caption{Using the BIC score.}
        \label{fig:structure-learning-child-5000-bic}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\linewidth}
        \hspace{-0.0cm}
        \includegraphics[scale=0.36]{fig/structure-learning-child-5000-bayes-3_0}
