...
Chater 2 serves as an introduction to the fundamentals of the probabily theory and provides necessary foundations for understanding the rest of this thesis and an overview of the notation used.
...
\subsection{Learning specific structures (work in progress)}
tree structures
\begin{itemize}
