...
To improve the user experience the GUI saves last state of its components to an \srccode{.ini} file, ie. contents of textfields, learning method that was last used, last query etc.
