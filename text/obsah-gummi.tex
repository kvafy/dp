...
\end{itemize}
Maximum tolerance for differences of $P(ViolentCrimesPerPop \mid X)$ is, again, 0.05 with the exception for attributes $MedNumBR$ and $pctUrban$ which are unevenly distributed because of binning (maximal differences for these attributes 0.12) and it is reasonable to remove them.
